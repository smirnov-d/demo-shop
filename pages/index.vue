<template>
    <div>
        ...
        <ul class="pl-0 custom-marker">
            ...
            <li class="error">Умная загрузка шрифтов без FOUT, FOIT, FOFT (распространённая проблема при использовании своих
...
<style>
    ...
    .custom-marker .success::marker{
        content: '✓';
        color: #10ff76;
    }
    .custom-marker .error::marker{
        content: "✕";
        color: red;
    }
</style>
